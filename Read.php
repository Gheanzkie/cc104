...
if ($_SESSION['role'] !== 'admin') {
    echo "<script>alert('Unauthorized access.'); window.location.href='exam.php';</script>";
    exit();
}
...
<body>
    <div class="bg-dark d-flex justify-content-center align-items-center w-100 vh-100">
        <div class="bg-white p-4 h-100 w-100 rounded">
            <h2 class="d-flex justify-content-center">Student List</h2>
            <h4>Welcome Admin Ghean!</h4>
                ...
                <thead>
                    ...
                    <th>Name</th>
                      <th>Course</th>
                        <th>Year Level</th>
                          <th>Section</th>
                            <th><a href="sessiondel.php" class="btn btn-danger">Logout</a></th>
                </thead>
                <tbody>
                    <?php
